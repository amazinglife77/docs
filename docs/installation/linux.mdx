...
- Füge das evcc APT Repository hinzu:
  ...
  <TabItem value="Nightly" label="Nightly">
    Da https://dl.cloudsmith.io/public/evcc/stable/debian.deb.txt fehlerhaft ist (Datum: 22.05.2022), muss die Datei /etc/apt/sources.list.d/evcc-stable.list wie folgt korrigiert werden.
